...
function App() {
  ...
  const copyPasswordToClpboard = useCallback(() => {
    ...
    // passwordRef.current?.setSelectionRange(0,3); //---> selecting only limited range
    ...
    <>
      <div className="w-full max-w-lg mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <button onClick={copyPasswordToClpboard} className="outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0">Copy</button>
        </div>
